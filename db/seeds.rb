...
v4 = Venue.create!(address: "4289 Buckskin rd, Ellicott, MD 29045")
v5 = Venue.create!(address: "6443 Wonderlust dr, Fredrick, MD 67405")
v6 = Venue.create!(address: "7365, Ground Gator rd, Tampa, FL 14034")
v7 = Venue.create!(address: "9864, Fish Taco dr, Miami, FL 72074")
v8 = Venue.create!(address: "3654, Sunset dr, Frankfort, KY 21027")
...
e6 = Event.create!(name: 'Burning Man', start: DateTime.parse("2021/06/24 19:00:00 EST"), end: DateTime.parse("2021/06/26 02:00:00 EST"), summary: "Burning Man", description: 'Rock & Roll', price: 550,  status: "On Schedule", age_restriction: 21, presented_by: "Burning Man", image: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.behance.net%2Fgallery%2F43329797%2FLogo-Burning-Man&psig=AOvVaw0WKmXwb0bZAFmoprJnMzUD&ust=1617065216645000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCPDUicaj1O8CFQAAAAAdAAAAABAD", user_id: u13.id, venue_id: v6.id)
